...
parser.add_argument('--config', default='/media/gxx/Data2/lht/program-py/HPLO2020/runs/20220711_220943__foldFULL_HPLONet_32_batch1_optimadam_adam_lr0.0001-wd0.0_epochs5_deepsupFalse_fp16_warm3__normgroup_dropout0.0_warm_restartFalse/20220711_220943__foldFULL_HPLONet_32_batch1_optimadam_adam_lr0.0001-wd0.0_epochs5_deepsupFalse_fp16_warm3__normgroup_dropout0.0_warm_restartFalse.yaml', type=str, metavar='PATH',
...
parser.add_argument('-a', '--arch', metavar='ARCH', default='HPLONet',
...
def main(args):
    ...
    for model_args in args_list:
        ...
        # model = model_maker(c=4, n=32, channels=128, groups=16, norm='sync_bn', num_classes=4)
        print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
    ...
    # generate_segmentations((loader_minmax, loader_zscore), model, None, args)
        ...
        for model, normalisation in zip(models, normalisations):
            ...
            with autocast():
                with torch.no_grad():
                    ...
                    # segs = torch.zeros((1, 4, 155, 240, 240))
