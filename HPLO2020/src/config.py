...
user = "YOU"
BRATS_TRAIN_FOLDERS = f"/media/gxx/Data2/lht/data/brain/BraTs2020/MICCAI_BraTS2020_TrainingData"
BRATS_VAL_FOLDER = f"/media/gxx/Data2/lht/data/brain/BraTs2020/MICCAI_BraTS2020_ValidationData"
